                ...
                if (item.to.difference(item.from).inDays != 0) {
                  ...
                  if (globals.assignments.isNotEmpty) {
                    for (int i = 0; i <globals.assignments.length; i++) {
                      if (globals.assignments.elementAt(i).to.day == item.to.day &&
                          globals.assignments.elementAt(i).to.month == item.to.month &&
                          globals.assignments.elementAt(i).to.year == item.to.year &&
                          globals.assignments.elementAt(i).to.hour == item.to.hour &&
                          globals.assignments.elementAt(i).to.minute == item.to.minute &&
                          globals.assignments.elementAt(i).from.day == item.from.day &&
                          globals.assignments.elementAt(i).from.minute == item.from.minute &&
                          globals.assignments.elementAt(i).from.year == item.from.year &&
                          globals.assignments.elementAt(i).from.month == item.from.month &&
                          globals.assignments.elementAt(i).from.hour == item.from.hour &&
                          globals.assignments.elementAt(i).type == item.type &&
                          globals.assignments.elementAt(i).allDay == item.allDay &&
                          globals.assignments.elementAt(i).page == item.page &&
                          globals.assignments.elementAt(i).title == item.title
                      )
                      {
                  ...
                  if (globals.completedAssignments.isNotEmpty) {
                    for (int i = 0; i <globals.completedAssignments.length; i++) {
                      if (globals.completedAssignments.elementAt(i).to.day == item.to.day &&
                          globals.completedAssignments.elementAt(i).to.month == item.to.month &&
                          globals.completedAssignments.elementAt(i).to.year == item.to.year &&
                          globals.completedAssignments.elementAt(i).to.hour == item.to.hour &&
                          globals.completedAssignments.elementAt(i).to.minute == item.to.minute &&
                          globals.completedAssignments.elementAt(i).from.day == item.from.day &&
                          globals.completedAssignments.elementAt(i).from.minute == item.from.minute &&
                          globals.completedAssignments.elementAt(i).from.year == item.from.year &&
                          globals.completedAssignments.elementAt(i).from.month == item.from.month &&
                          globals.completedAssignments.elementAt(i).from.hour == item.from.hour &&
                          globals.completedAssignments.elementAt(i).type == item.type &&
                          globals.completedAssignments.elementAt(i).allDay == item.allDay &&
                          globals.completedAssignments.elementAt(i).page == item.page &&
                          globals.completedAssignments.elementAt(i).title == item.title
                      )
                      {
